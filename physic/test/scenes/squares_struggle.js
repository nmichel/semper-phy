...
export default function buildScene() {
  ...
  scene.addBody(new RigidBody(0, new Vector2(800, 20), new Box(1430, 20), new Vector2(0, 0), 0, 0));
  scene.addBody(new RigidBody(0, new Vector2(800, 900), new Box(1430, 20), new Vector2(0, 0), 0, 0));
